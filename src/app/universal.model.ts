...
export interface User {
    ...
    bucket:string[] | FieldValue;
    storeLoc:string[] | FieldValue; storeCam:string[] | FieldValue; storeSav:string[] | FieldValue;
...
export interface Shop {
    id: string;
    email: string; phone: string; name:string; logo:string, banner:string;
